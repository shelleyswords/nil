# The NIL Game Plan — Welcome Email Sequence

A 6-email automated welcome sequence that runs the moment someone downloads the free **NIL Money Starter Checklist**. It delivers the lead magnet, teaches genuinely useful money lessons in the brand's plain-English voice, builds trust, and ends with a soft pitch for **The NIL Game Plan** ($29 launch price / $49 regular).
...
| 6 | `email-6.md` | Day 10 | Soft pitch The NIL Game Plan as the natural next step | **[Get the Game Plan]** → /playbook.html |

---

## Sequence strategy (why it's built this way)

**Deliver first, sell last.** Email 1 hands over what they signed up for and gives an instant win, so the relationship starts with value, not a pitch. Emails 2–5 are pure education — each one teaches one chapter-sized idea from The Game Plan and ends by handing the reader a concrete action, not a "buy now."
...
**Each email teaches one thing.** Short paragraphs, one core idea, one clear next step. No email tries to cover everything — that's what The Game Plan is for, and the sequence is honest about that gap.
...
4. **Wire up the links:**
   ...
   - Email 6: point **[Get the Game Plan]** to **/playbook.html** (the sales page).

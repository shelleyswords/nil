...
## The one-line brand descriptor (the through-line)

Use this idea, reworded to fit each character limit:

> **Plain-English money tips for NCAA athletes. Keep more of your NIL check. Education, not advice.**

The three job-to-be-done phrases that should always come through:
1. **Who it's for** — college / NCAA athletes
2. **What they get** — keep, grow, protect NIL money / plain-English money tips
3. **The trust signal** — education, not advice (and: no jargon / no suits / no fees)

---

## Platform bios (written to each character limit)

### TikTok — bio limit ~80 characters
TikTok bios are tiny. Lead with the value + one CTA. (Add the link in the website field, not the bio text.)

**Option A (recommended):**
> 💸 Keep more of your NIL check
> Plain-English money tips • not advice
> Free checklist ⬇️

**Option B (punchier):**
> NIL money, explained simply 💰
> No jargon. No suits. No fees.
> Free checklist ⬇️

*Pin a fee-outrage video (Script 28) to the top of the profile. TikTok shows pinned videos first.*

---

### Instagram — bio limit 150 characters
Instagram allows line breaks and emojis. Use them for scannability.

**Recommended:**
> 💸 Plain-English money tips for college athletes
> Keep • grow • protect your NIL check
> Education, not advice
> 👇 Free NIL Money Checklist

*(~135 characters — within limit. The 👇 points at the link sticker / link-in-bio.)*

**Category (Instagram "Category" field):** Education / Personal finance
**Bio link:** the link-in-bio page (see structure below).
...
>
> NIL money is real income, and nobody's teaching athletes the basics in their own language. This channel does. Quick, no-nonsense Shorts on:
> • Taxes (what you actually owe + how to not get wrecked in April)
> • Fees (how a "tiny" 1% can cost you $300k–$500k by retirement)
> • Scams (the DM "opportunities" hunting young athletes)
> • Simple wins (high-yield savings, Roth IRAs, index funds — explained simply)
>
> Everything here is EDUCATION, not personalized financial, tax, or legal advice. Always consult a licensed professional about your specific situation.
>
> 👇 Start with the free NIL Money Starter Checklist:
> [link]
...
>
> 👇 Grab the free NIL Money Starter Checklist: [link]

---

## Banner / cover copy concepts

*Keep all banners in the brand visual system: deep navy (#0B1F3A) background, athletic green (#1F7A4D) + gold (#C8A24B) accents, bold white sans-serif. Clean, modern, premium. No real faces or team logos.*

### YouTube channel banner (2560×1440, safe area 1546×423 centered)
...
- **Main line:** "NIL money, explained simply."
- **Sub-line:** For athletes & the families who help them.
...
### Profile photo (all platforms — identical)
- **AI prompt:** *"Minimalist circular logo, deep navy background, gold monogram 'NP' or a small gold playbook/clipboard icon, clean modern athletic finance brand mark, high contrast, no text clutter."*

---

## Link-in-bio structure

You need a single link that works in every bio. Use a simple link-in-bio page (your own site, a Stan Store, Beacons, Linktree, etc.) styled in navy + gold. **The #1 goal of this page is the free checklist email opt-in** — that's the funnel engine. Put it first and biggest.

**Recommended link-in-bio layout (top to bottom):**
...
**Notes:**
- On **TikTok and Instagram**, put the link in the dedicated website/link field (and use IG's "link sticker" in Stories).
- In **captions**, always say "link in bio" (you can't put clickable links in TikTok/IG captions).
- On **YouTube and Facebook**, you *can* drop the direct link in the description — link straight to the free-checklist landing page there.
- Use a **consistent UTM tag** per platform (e.g. `?utm_source=tiktok`) so you can see which platform drives the most checklist sign-ups.
...
- [ ] YouTube banner + Facebook cover designed in brand colors
- [ ] Instagram: 3 strongest videos pinned (fee / tax / simple-win)
- [ ] TikTok: best fee-outrage video pinned
- [ ] IG Story highlights created (Start Here · Taxes · Fees · Scams · Invest · Free Checklist)
- [ ] UTM tags set per platform on the bio link
- [ ] Disclaimer present somewhere on the link-in-bio page
